...
if (class(test_server) != "try-error")
  webdav_download_file(base_url = test_server$url,
    ...
    verbose = TRUE)
#> ℹ Base URL: <http://webdavserver.net/User4a150ce>
#> ℹ Downloading from: Project.pdf to: /tmp/RtmpY9tWXm/Project.pdf
#> ℹ Server Path: <http://webdavserver.net/User4a150ce/Project.pdf>
#> ℹ Local Destination Path: /tmp/RtmpY9tWXm/Project.pdf
#> ℹ Base URL: <http://webdavserver.net/User4a150ce/Project.pdf>
#> ℹ Username: "Not provided"
#> ✔ Request object created successfully.
#> ! No authentication added.
#> ✔ Resource successfully downloaded from <http://webdavserver.net/User4a150ce/Project.pdf>
#> ✔ Resource successfully written to /tmp/RtmpY9tWXm/Project.pdf
#> [1] TRUE
