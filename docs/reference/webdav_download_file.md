...
if (class(test_server) != "try-error")
  webdav_download_file(base_url = test_server$url,
    ...
    verbose = TRUE)
#> ℹ Base URL: <http://webdavserver.net/User7fd65b8>
#> ℹ Downloading from: Project.pdf to:
#>   /var/folders/j9/7g_srh2x0d71c5q0pbj5mxh40000gn/T//RtmpDk3odR/Project.pdf
#> ℹ Server Path: <http://webdavserver.net/User7fd65b8/Project.pdf>
#> ℹ Local Destination Path:
#>   /var/folders/j9/7g_srh2x0d71c5q0pbj5mxh40000gn/T//RtmpDk3odR/Project.pdf
#> ℹ Base URL: <http://webdavserver.net/User7fd65b8/Project.pdf>
#> ℹ Username: "andreleite"
#> ✔ Request object created successfully.
#> ✔ Basic authentication added.
#> ✔ Resource successfully downloaded from <http://webdavserver.net/User7fd65b8/Project.pdf>
#> ✔ Resource successfully written to /var/folders/j9/7g_srh2x0d71c5q0pbj5mxh40000gn/T//RtmpDk3odR/Project.pdf
#> [1] TRUE
